...
thetaHat=zetaHat;%+norm(e1)*ones(5,1)+norm(e2)*ones(5,1);
...
%zetaHatDot=-gamma*(e2'*YdDotDot)'+a2*gamma*YdDot'*e2+gamma*YfdDot'*Epsilon;%+gamma*Yd'*e1+gamma*Yd'*e2;
zetaHatDot=gamma*Yd'*e2;%+gamma*Yd'*e1;
